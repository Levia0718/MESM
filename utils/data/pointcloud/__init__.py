...
pdb_directory = "{}/datasets/raw_data/STRING_AF2DB".format(current_file_path)
# pdb_directory = "{}/datasets/raw_data/Yeast_AF2DB".format(current_file_path)
...
with open(f'{save_path}/pointclouds_STRING.pkl', 'wb') as f:
    pickle.dump(dataset, f)
# with open(f'{save_path}/pointclouds_Yeast.pkl', 'wb') as f:
#     pickle.dump(dataset, f)
